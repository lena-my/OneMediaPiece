...
/**
 * Servlet implementation class ArticleReadModereServlet
 */
@WebServlet("/ArticleReadModere")
public class ArticleReadModereServlet extends HttpServlet {
     ...
     */
    public ArticleReadModereServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/ArticleReadModere.jsp").forward( request, response );
	}
