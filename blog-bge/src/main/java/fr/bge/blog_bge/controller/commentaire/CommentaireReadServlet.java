...
/**
 * Servlet implementation class CommentaireReadServlet
 */
@WebServlet("/CommentaireRead")
public class CommentaireReadServlet extends HttpServlet {
