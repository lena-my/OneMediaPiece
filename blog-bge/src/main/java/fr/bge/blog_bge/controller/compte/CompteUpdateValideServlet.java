...
/**
 * Servlet implementation class CompteUpdateValideServlet
 */
@WebServlet("/CompteUpdateValide")
public class CompteUpdateValideServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private CompteService service = CompteServiceImpl.getInstance();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CompteUpdateValideServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/CompteUpdateValide.jsp").forward( request, response );
	}
